              ...
              <div className="flex flex-col gap-0.5 min-w-0">
                ...
                {source.status === 'processing' && (
                  <div className="mt-3 space-y-1.5 min-w-[250px] max-w-md">
                    <div className="flex items-center justify-between text-[9px] font-bold uppercase tracking-widest text-[#0f62fe] dark:text-blue-400">
                      <span className="flex items-center gap-1.5">
                        <Loader2 className="w-3 h-3 animate-spin text-[#0f62fe] dark:text-blue-400" />
                        Crawling & Ingesting Pages...
                      </span>
                      <span>{source.pages_crawled || 0} / {source.max_pages || 200}</span>
                    </div>
                    <div className="h-1 w-full bg-slate-100 dark:bg-slate-950 border border-slate-200 dark:border-slate-850 rounded-full overflow-hidden">
                      <motion.div 
                        initial={{ width: 0 }}
